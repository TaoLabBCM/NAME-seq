                    ...
                    if chrom_found:
                        ...
                        if ref == 'C':
                            ...
                            if cor <= cor_threshold:
                                continue
                            CtoT = float(line_list[4])/cor
                            line_output.append([chrom, line_list[0], ref, '+', line_list[1], line_list[2], line_list[3], line_list[4], str(cor), str(CtoT)])
